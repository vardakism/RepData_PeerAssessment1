...
---
This is a R Markdown document to guide you through the analysis of personal movement activity data as a subject of the reproducible research course assignment. Please see the [README.md](https://github.com/rdpeng/RepData_PeerAssessment1/blob/master/README.md) for any further information.
...
# Check which are the weekend data
actv$wnd<-0
